...
\begin{subfigure}{0.3\textwidth}
        \includegraphics[width=0.3\textwidth]{Genre 1}
  \caption{\small Genre \#1, pop music}
\end{subfigure}

\begin{subfigure}{0.3\textwidth}
  \includegraphics[width=0.3\textwidth,right]{Genre 2}
  \caption{\small Genre \#2, jazz and blues}
\end{subfigure}

\begin{subfigure}{0.3\textwidth}
  \includegraphics[width=0.3\textwidth,right]{Genre 3}
...
\begin{figure}[H]
\begin{subfigure}{0.3\textwidth}
  \includegraphics[width=0.3\textwidth]{Genre 4}
  \caption{\small Genre \#4, country and folk}
\end{subfigure}

\begin{subfigure}{0.3\textwidth}
  \includegraphics[width=0.3\textwidth]{Genre 5}
  \caption{\small Genre \#5, rap and hip hop}
\end{subfigure}

\begin{subfigure}{0.3\textwidth}
  \includegraphics[width=0.3\textwidth]{Genre 6}   
